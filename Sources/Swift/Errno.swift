...
public enum Errno: Int32, CaseIterable, Error, Codable {
    ...
    static var EOPNOTSUPP: Errno { .ENOTSUP }
    #else
    case EOPNOTSUPP
    #endif
    case EOVERFLOW
    ...
    public static var EWOULDBLOCK: Errno { .EAGAIN }
    #else
    case EWOULDBLOCK
    #endif
    case EXDEV
    ...
    public static var ELAST: Errno { Errno(rawValue: cValueELAST())! }
    #endif
    ...
    // MARK: Public
    public var rawValue: Int32 { cValue(ofErrno: self) }
